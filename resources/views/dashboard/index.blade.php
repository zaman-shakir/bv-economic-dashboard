            ...
            <div class="mb-6 flex flex-wrap items-center gap-6 w-full">
                ...
                <div class="flex items-center gap-6 flex-1 min-w-full xl:min-w-0">
                    ...
                    <a href="{{ route('dashboard', ['filter' => 'overdue']) }}"
                       class="flex-1 px-4 py-2 rounded-lg font-medium transition text-center whitespace-nowrap flex items-center justify-center gap-2 {{ $currentFilter === 'overdue' ? 'bg-red-600 text-white' : 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 hover:bg-red-200 dark:hover:bg-red-900/50' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('dashboard', ['filter' => 'unpaid']) }}"
                       class="flex-1 px-4 py-2 rounded-lg font-medium transition text-center whitespace-nowrap flex items-center justify-center gap-2 {{ $currentFilter === 'unpaid' ? 'bg-yellow-600 text-white' : 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300 hover:bg-yellow-200 dark:hover:bg-yellow-900/50' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
