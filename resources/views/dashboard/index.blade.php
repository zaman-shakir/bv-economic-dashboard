        ...
        <div class="max-w-[1600px] mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center gap-2">
                ...
                <a href="{{ route('dashboard', ['filter' => 'all']) }}"
                   class="flex-1 px-4 py-2 rounded-lg font-medium transition-all duration-200 text-center focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 {{ $currentFilter === 'all' ? 'bg-blue-600 text-white shadow-md' : 'bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 border border-gray-200 dark:border-gray-700' }}">
                    {{ __('dashboard.filter_all') }}
                </a>

                <!-- Overdue only -->
                <a href="{{ route('dashboard', ['filter' => 'overdue']) }}"
                   class="flex-1 px-4 py-2 rounded-lg font-medium transition-all duration-200 text-center focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 {{ $currentFilter === 'overdue' ? 'bg-red-600 text-white shadow-md' : 'bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-red-50 dark:hover:bg-red-900/20 border border-gray-200 dark:border-gray-700' }}">
                    {{ __('dashboard.filter_overdue') }}
                </a>

                <!-- Unpaid only -->
                <a href="{{ route('dashboard', ['filter' => 'unpaid']) }}"
                   class="flex-1 px-4 py-2 rounded-lg font-medium transition-all duration-200 text-center focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 {{ $currentFilter === 'unpaid' ? 'bg-amber-500 text-white shadow-md' : 'bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-amber-50 dark:hover:bg-amber-900/20 border border-gray-200 dark:border-gray-700' }}">
                    {{ __('dashboard.filter_unpaid') }}
                </a>

                <!-- By Employee -->
                <a href="{{ route('dashboard', ['filter' => $currentFilter, 'grouping' => 'employee']) }}"
                   class="flex-1 px-4 py-2 rounded-lg font-medium transition-all duration-200 text-center focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 {{ ($currentGrouping ?? 'employee') === 'employee' ? 'bg-indigo-600 text-white shadow-md' : 'bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 border border-gray-200 dark:border-gray-700' }}">
                    By Employee
                </a>

                <!-- By Other Ref -->
                <a href="{{ route('dashboard', ['filter' => $currentFilter, 'grouping' => 'other_ref']) }}"
                   class="flex-1 px-4 py-2 rounded-lg font-medium transition-all duration-200 text-center focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 {{ ($currentGrouping ?? 'employee') === 'other_ref' ? 'bg-indigo-600 text-white shadow-md' : 'bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 border border-gray-200 dark:border-gray-700' }}">
                    By Other Ref
                </a>

                <!-- All employees dropdown -->
                <select id="employeeFilter" onchange="filterByEmployee(this.value)"
                        class="flex-1 px-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 cursor-pointer hover:border-blue-400 transition">
                ...
                <button
                    id="syncButton"
                    onclick="syncNow()"
                    class="flex-1 px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white font-medium rounded-lg transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
                >
